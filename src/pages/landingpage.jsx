...
function LandingPage() {
  ...
  return (
    <>
      <div className="relative h-[40rem] md:h-[44rem]  flex justify-center bg-custom-gradient bg-no-repeat bg-cover bg-center sm:bg-none mb-40 md:mb-0" style={{ backgroundImage: `url(${backgroundImage})` }}>
        <Navbar />
        <div className='absolute flex w-[90%] h-[30rem] top-[15%] gap-[8%] md:flex-row flex-col '>
          <div className='md:w-1/2 w-full flex flex-col  items-center '>
            ...
            <p className='md:w-4/5 xl:w-4/5 ml-1 mt-10 text-center text-[#252525f2] font-semibold text-[19px]'>Your trusted source for skilled daily wage employees. Connect with reliable workers today!</p>
          </div>
      ...
      <Dot className=' w-9 h-9 relative top-[35rem] left-[15%] rounded-full bg-[#c597f9] z-10 blur-[0.5px]'/>
      <Dot className=' w-6 h-6 relative top-[30rem] left-[80%] rounded-full bg-[#ffc279] z-10 blur-[0.5px]'/>
      <Dot className=' w-3 h-3 relative top-[6rem] left-[57%] rounded-full bg-[#74e3ea] z-10 blur-[0.5px]'/>
        ...
        <div className="aspect-w-16 aspect-h-9 w-full max-w-screen-lg">
          <div className='h-full w-full flex flex-col sm:flex-row items-center justify-center gap-10 p-10'>
            <div className='w-full sm:w-[27rem] flex flex-col items-center justify-center text-center sm:order-1 order-2'>
              ...
              <p className='text-base sm:text-[17px] mt-0 sm:mt-5 p-5'>Join our platform to connect with talented individuals and find opportunities tailored to your needs. Showcase your skills, browse profiles, review ratings, and hire with confidence. Enjoy seamless booking and communication. Sign up now!</p>
      ...
      <hr />
      <Dot className=' w-9 h-9 relative top-[32rem] left-[14%] rounded-full bg-[#c597f9] blur-[0.5px]'/>
      <Dot className=' w-6 h-6 relative top-[30rem] left-[80%] rounded-full bg-[#74e3ea] blur-[0.5px]'/>
      <Dot className=' w-3 h-3 relative top-[8rem] left-[60%] rounded-full bg-[#ffc279] blur-[0.5px]'/>
      <Dot className=' w-2 h-2 relative top-[4rem] left-[44%] rounded-full bg-[#4E79F0] blur-[0.5px]'/>
        ...
        <div className="aspect-w-16 aspect-h-9 w-full max-w-screen-lg">
          <div className='h-full w-full flex flex-col sm:flex-row items-center justify-center gap-10 p-10'>
            ...
            <div className='w-full sm:w-[27rem] flex flex-col items-center justify-center text-center'>
              ...
              <p className='text-base sm:text-[17px] mt-0 sm:mt-5 p-5'>Sign in to connect with talented individuals and discover tailored opportunities. Manage your profile, review ratings, and enjoy seamless booking and communication. Log in now to continue your journey!</p>
      ...
      <div className="relative h-[40rem] md:h-[44rem]  flex justify-center mb-20 ">
        ...
        <img className='relative w-[15rem] xl:w-[21rem] h-fit md:w-[21rem] sm:w-[19rem] mt-5 md:mt-0 ml-[15%] xs:ml-[18%] sm:ml-[25%] md:ml-[9%] rounded-md md:rounded-md shadow-customShadow' src={Plumber} alt="" />
          <div className='md:w-1/2 w-full h-3/4 flex flex-col  items-center justify-center'>
            <div className='w-4/5 2xl:text-[43px] xl:text-[42px] lg:text-[39px] text-[32px] font-bold pt-0 text-center pl-1'> Thank You for Visiting !</div>
